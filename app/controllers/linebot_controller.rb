  ...
  def callback
    ...
    events.each { |event|
      if event.message['text'].include?("一成からめいちゃんへ")
        response = ["大好きだよ","めいちゃんと居ると素で居られるよ！","すみれが会いたがってるよ","疲れた時は一緒に寝ようね(_ _).｡o○","一緒に居ようね。","いつでもうちにおいで！","めいちゃんから一成へ","めっちゃ好き！！","一年間支えてくれてありがとう","うんこめい！！","飲み過ぎ注意（怒）","今日もお疲れ様","もう少しで今年も終わるね。2021年はどんな年になるかな？","可愛いね♡","塩昆布食べたい","愛してるよ","スノボー行きたい！連れてけめい！","キキちゃんが会いたがってるよ！","岩盤浴行くぞー！！！","好きだよ","ダイエットは( ͡° ͜ʖ ͡°)？"].shuffle.first
